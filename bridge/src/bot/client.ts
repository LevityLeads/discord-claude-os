...
import { startScheduler } from "../scheduled/scheduler.js";
...
export async function startBot(): Promise<Client> {
  ...
  client.on("ready", async () => {
    ...
    try {
      ...
      // Start the scheduler after Discord is ready
  ...
  client.on("interactionCreate", async (interaction: Interaction) => {
    try {
      ...
      void reportError(client, "Interaction error", error, {
  ...
  client.on("messageCreate", async (message) => {
    try {
      ...
      void reportError(client, "messageCreate error", error, {
  ...
  client.on("error", (error) => {
    ...
    void reportError(client, "Discord client error", error);
  });
